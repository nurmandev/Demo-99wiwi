...
client = pymongo.MongoClient("mongodb+srv://resume:1234@cluster0.8114dlp.mongodb.net/99wiwi2?retryWrites=true&w=majority")  # Modify the connection URL as needed
db = client["test"] 
